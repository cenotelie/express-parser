...
namespace Express
{
	...
	internal class ExpressLexer : ContextFreeLexer
	{
		...
		private static readonly Symbol[] terminals = {
			...
			new Symbol(0x005B, "AND"),
			new Symbol(0x005C, "NOT"),
			new Symbol(0x005D, "EXISTS"),
			new Symbol(0x005E, "{"),
			new Symbol(0x005F, "}"),
			new Symbol(0x0060, "TYPEOF"),
			new Symbol(0x0061, ":<>:"),
			new Symbol(0x0062, "IN"),
			new Symbol(0x0063, "<"),
			new Symbol(0x0064, "<="),
			new Symbol(0x0065, ">="),
			new Symbol(0x0066, ">"),
			new Symbol(0x0067, "ONEOF"),
			new Symbol(0x0069, "STRING"),
			new Symbol(0x006A, "NUMBER"),
			new Symbol(0x006B, "BOOLEAN"),
			new Symbol(0x006C, "LOGICAL"),
			new Symbol(0x006D, "BINARY"),
			new Symbol(0x006E, "INTEGER"),
			new Symbol(0x006F, "REAL"),
			new Symbol(0x0070, "true"),
			new Symbol(0x0071, "false") };
		/// <summary>
