...
namespace Express
{
	...
	internal class ExpressLexer : ContextFreeLexer
	{
		...
		private static readonly Symbol[] terminals = {
			...
			new Symbol(0x002B, "true"),
			new Symbol(0x002C, "false"),
			new Symbol(0x002D, "STRING"),
			new Symbol(0x002E, "NUMBER"),
			new Symbol(0x002F, "BOOLEAN"),
			new Symbol(0x0030, "LOGICAL"),
			new Symbol(0x0031, "BINARY"),
			new Symbol(0x0032, "INTEGER"),
			new Symbol(0x0033, "REAL"),
			new Symbol(0x0034, ">="),
			new Symbol(0x0035, ">"),
			new Symbol(0x0036, "<"),
			new Symbol(0x0037, "<="),
			...
			new Symbol(0x0039, "("),
			new Symbol(0x003A, ")"),
			new Symbol(0x003B, "NOT"),
			new Symbol(0x003C, "OR"),
			new Symbol(0x003E, "AND"),
			new Symbol(0x0040, "{"),
			new Symbol(0x0041, "}"),
			new Symbol(0x0042, "SELF"),
			new Symbol(0x0043, "EXISTS"),
			new Symbol(0x0044, "WHERE"),
			new Symbol(0x0045, ":"),
			new Symbol(0x0046, ";"),
			new Symbol(0x0048, "SUBTYPE"),
			new Symbol(0x0049, "OF"),
			new Symbol(0x004A, ","),
			new Symbol(0x004C, "OPTIONAL"),
			new Symbol(0x004D, "ABSTRACT"),
			new Symbol(0x004E, "ENTITY"),
			new Symbol(0x0050, "END_ENTITY"),
			new Symbol(0x0051, "SELECT"),
			new Symbol(0x0053, "TYPE"),
			new Symbol(0x0054, "="),
			new Symbol(0x0055, "END_TYPE"),
			new Symbol(0x0056, "USE"),
			new Symbol(0x0057, "FROM"),
			new Symbol(0x0058, "SCHEMA") };
		/// <summary>
