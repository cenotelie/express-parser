...
namespace Express
{
	...
	internal class ExpressLexer : ContextFreeLexer
	{
		...
		private static readonly Symbol[] terminals = {
			...
			new Symbol(0x0048, "USE"),
			new Symbol(0x0049, "FROM"),
			new Symbol(0x004A, ";"),
			new Symbol(0x004B, "SCHEMA"),
			new Symbol(0x004C, "TYPE"),
			new Symbol(0x004D, "="),
			new Symbol(0x004E, "END_TYPE"),
			new Symbol(0x004F, "SELECT"),
			new Symbol(0x0050, "("),
			new Symbol(0x0051, ","),
			new Symbol(0x0053, ")"),
			new Symbol(0x0054, "ENTITY"),
			new Symbol(0x0057, "END_ENTITY"),
			new Symbol(0x0058, "ENUMERATION"),
			new Symbol(0x0059, "OF"),
			new Symbol(0x005B, "ABSTRACT"),
			new Symbol(0x005C, "SUBTYPE"),
			new Symbol(0x005E, "SUPERTYPE"),
			new Symbol(0x005F, "DERIVE"),
			new Symbol(0x0062, ":"),
			new Symbol(0x0063, ":="),
			new Symbol(0x0065, "UNIQUE"),
			new Symbol(0x006A, "SELF"),
			new Symbol(0x006B, "SELF\\"),
			new Symbol(0x006C, "\\"),
			new Symbol(0x006D, "."),
			new Symbol(0x006F, "["),
			new Symbol(0x0070, "]"),
			new Symbol(0x0071, "LIST"),
			new Symbol(0x0072, "*"),
			new Symbol(0x0075, "SET"),
			new Symbol(0x0076, "ARRAY"),
			new Symbol(0x0077, "BAG"),
			new Symbol(0x0078, "QUERY"),
			new Symbol(0x0079, "|"),
			new Symbol(0x007A, "?"),
			new Symbol(0x007B, "OPTIONAL"),
			new Symbol(0x007C, "WHERE"),
			new Symbol(0x0080, "OR"),
			new Symbol(0x0081, "XOR"),
